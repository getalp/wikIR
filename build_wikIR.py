...
def main():
    ...
    parser.add_argument('-out','--output_dir', nargs="?", type=str)
    parser.add_argument('-maxd','--max_docs', nargs="?", type=int, default = None)
    parser.add_argument('-ld','--len_doc', nargs="?", type=int, default = 200)
    parser.add_argument('-lq','--len_query', nargs="?", type=int, default = None)
    parser.add_argument('-mlen','--min_len_doc', nargs="?", type=int, default = 200)
    parser.add_argument('-mrel','--min_nb_rel_doc', nargs="?", type=int, default = 5)
    parser.add_argument('-val','--validation_part', nargs="?", type=int,default = 1000)
    parser.add_argument('-test','--test_part', nargs="?", type=int,default = 1000)
    parser.add_argument('-k','--k', nargs="?", type=int,default = 100)
    parser.add_argument('-title','--title_queries', action="store_true")
    parser.add_argument('-first','--only_first_links', action="store_true")
